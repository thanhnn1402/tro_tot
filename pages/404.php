<html style="height:100%" data-arp-injected="true">
...
<body style="color: #08a5bf; margin:0;font: normal 14px/20px Arial, Helvetica, sans-serif; height:100%; background-color: #fff;">
    <div style="height:auto; min-height:100%; ">
        <div style="text-align: center; width:880px; margin-left: -400px; position:absolute; top: 30%; left:50%;">
            <h1 style="margin:0; font-size:150px; line-height:150px; font-weight:bold;">404</h1>
            <h2 style="margin-top:20px;font-size: 30px;">KHÔNG TÌM THẤY TRANG
            </h2>
            <p>CÓ VẺ BẠN ĐANG TRUY CẬP ĐẾN MỘT TRANG NÀO ĐÓ KHÔNG TỒN TẠI HOẶC SẢY RA LỖI VUI LÒNG KIỂM TRA LẠI DƯỜNG DẪN</p>
        </div>
    </div>
    <div data-v-6d709352="">
        <!---->
